...
def retrieve_pokemons(): # First 10 item from the external API
...
def retrieve_pokemon(id): # Retrieve a pokemon by id
...
async def add_pokemon(pokemon_data: dict) -> dict: #Add a new pokemon in the DB
